...
#ifndef I2CBLDCEncoderDevice_hpp
#define I2CBLDCEncoderDevice_hpp

#include <stdlib.h>
#include "Wire.h"
#include "I2CDeviceWrapper.hpp"
#include "../Arduino-Rotational-Sensor/BLDCAngleSensor.hpp"


class I2CBLDCEncoderDevice : public I2CDeviceWrapper
{
public:
     ...
     */
    I2CBLDCEncoderDevice(uint8_t pinA, uint8_t pinB, uint8_t pinC);
     ...
     */
    static void update_all(){BLDCAngleSensor::update_all();}
...
private:
    BLDCAngleSensor* _sensor;  // Actual BLDCEncoder sensor
...
#endif /* I2CBLDCEncoderDevice_hpp */
